    ...
    ?>
        ...
        if( is_home() || is_front_page() ) {
            ...
            if( function_exists( 'travelify_featured_post_slider' ) )
                echo '<div class="featured-wrap clearfix">';
                    travelify_featured_post_slider();
                    // TODO: add tin tuc khuyến mãi hot
                    echo '<div class="saleoff-news">';
                        get_post_km();
                    echo '</div>';
        ...
        ?>
            <div class="page-title-wrap">
                <div class="container clearfix">
                    <?php
                    // TODO: Using breadcrumbs of Yoast Seo
            ...
            $i=0; while ( $get_featured_posts->have_posts()) : $get_featured_posts->the_post(); $i++;
                ...
                <div class="'.$classes.'">';
                        if( has_post_thumbnail() ) {
                            ...
                            $travelify_featured_post_slider .= get_the_post_thumbnail( $post->ID, 'featured', array( 'title' => esc_attr( $title_attribute ), 'alt' => esc_attr( $title_attribute ), 'class'    => 'pngfix' ) ).'</a></figure>';
                        }
...
if ( ! function_exists( 'get_post_km' ) ) :
/**
 * display featured post slider
 *
 */
function get_post_km() {
    global $post;
    $category_id = 11;
    ...
    if ($data->have_posts()) :
        $html = '<h2>Khuyến mãi tour</h2><div class="content-news">';
